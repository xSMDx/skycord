...
export const ownTileMenu = (
  ...
  { sep: true },
  { label: 'Mute',   icon: PhMicrophoneSlash, check: s.selfMuted,    onSelect: () => h.toggleMute() },
  { label: 'Deafen', icon: PhHeadphones,      check: s.selfDeafened, onSelect: () => h.toggleDeafen() },
  { label: 'Voice Settings', icon: PhSlidersHorizontal, onSelect: () => h.openVoiceSettings() },
  { sep: true },
  { label: 'Show Non-Video Participants', icon: PhUsersThree, check: s.showNonVideo,
    onSelect: () => h.toggleShowNonVideo() },
  { label: 'Show My Own Camera', icon: PhEye, check: s.showOwnCamera,
...
export const participantMenu = (
  ...
  { sep: true },
  { label: 'Mute',          icon: PhMicrophoneSlash,  check: s.muted,
    onSelect: () => h.toggleUserMute(p.id) },
  { label: 'Disable Video', icon: PhVideoCameraSlash, check: s.videoOff,
