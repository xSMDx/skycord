# Installing Skycord by hand

The short way is one command, and it is what most people should use:
[installing.md](./installing.md).

This page is the long way — Node, MongoDB, a web server and a process
manager, each installed and wired up yourself. Use it if you will not run
Docker, if you are packaging Skycord for something else, or if you simply want
to see every moving part.

Everything here still works and is still supported.
